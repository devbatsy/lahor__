...
__SYD.ctsec3_info_img_comp = () =>{
    return __c(
        'div',
        {
            style:`height:80vw;max-height:500px;min-height:400px;min-width:300px;position:relative;overflow:hidden;width:${__p(['ctsec3_info_comp','font'],'40px') === '40px' ? 'calc(60% - 37.5px)' : '80%'};background-position:center 0;background-image:url("../assets/a8.jpg")`,
            class:'thin_border'

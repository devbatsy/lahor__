        ...
        [
            __c(
                ...
                [
                    ...
                    sydDOM.createLogo(),
                    sydDOM.navMenu(),
                    __p(['navBar','param'],true) === true ? '' : __SYD.text_lib_type_h1_glob({cnt:'Lahor Apartments' , clr:'#b99d75' , size:'18px' , w:'700' , inject:'font-family:my_family;'}),
                    __SYD.reservation_btn(),
                    // sydDOM.belowNav(),
                    sydDOM.sideNav(),
                    sydDOM.mobileMenu(),
...
sydDOM.togMobileMenuListApartment = () =>{
    return createElement(
        ...
        [
            ...
            createElement(
                'div',
                {style:`row-gap:20px;display:flex;flex-direction:column;height:${__p(['togMobileMenuListApartment','tog'],false) === false ? '0px' : '200px'};overflow:scroll;transition:height linear .3s;`},
                [

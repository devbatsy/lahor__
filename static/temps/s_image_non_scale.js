                            ...
                            __c(
                                ...
                                [
                                    __c('div',{style:'display:flex;column-gap:10px;align-items:center'},[
                                        __SYD.iconify_20px({attr:'fa-solid fa-person-pregnant' , clr:'#fff'}),
                                    ...
                                    __c('div',{style:'display:flex;column-gap:10px;align-items:center'},[
                                        __SYD.iconify_20px({attr:'fa-solid fa-expand' , clr:'#fff'}),

    ...
    return __c(
        ...
        [
            ...
            __c(
                'div',
                {
                    style:`width:${__p(['ssec2_static_overlay_image','font'],'40px') === '40px' ? 'revert-layer' : '100%'};height:fit-content;min-height:300px;min-width:300px;text-align:center;` + __sC['page3FloatText']({method:'add',style:{justifyContent:'flex-start',alignItems:'flex-start',padding:'0 20px'}}),
                ...
                [
                    ...
                    __c(
                        ...
                        [
                            __SYD.ssec2_static_overlay_image_ul_list({cnt:'24/7 High-Speed Wi-Fi'}),
                            __SYD.ssec2_static_overlay_image_ul_list({cnt:'24/7 Privacy and Security'}),
                            __SYD.ssec2_static_overlay_image_ul_list({cnt:'Consistent Power Supply'}),
                            __SYD.ssec2_static_overlay_image_ul_list({cnt:'Comfortable Living Areas'}),
                            __SYD.ssec2_static_overlay_image_ul_list({cnt:'Fully Equipped Kitchenette'}),
                        ]
                    )
                ]
            ),

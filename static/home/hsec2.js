...
__SYD.hsec2_increment_counter_parent = () =>{
    return __c(
        'div',
        {
            style:`display:flex;row-gap:25px;column-gap:25px;flex-wrap:wrap;justify-content:center;align-items:center;border-top:3px double #171717;margin-bottom:30px;padding:30px 10px;opacity:${__p(['hsec2_increment_counter_parent' , 'data'],[0])[0] <= 0 ? '0' : '1'}`,
            class:__p(['hsec2_increment_counter_parent' , 'data'],[0])[0] <= 0 ? '' : 'downSlide_animate'
        },
        [

...
const data = [
    {ilabel:'fa-solid fa-bolt',main:' 24Hours Power Supply',cnt:'Uninterrupted Power supply'},{ilabel:'fa-solid fa-kitchen-set',main:'Modern Kitchen',cnt:'Elegant. Efficient. Modern'},{ilabel:'fa-solid fa-gamepad',main:'Out door Snooker',cnt:'Fun. Competitive. Stylish.'}
]
...
__SYD.gallery_feature_images_comp = (display) =>{
    return __c(
        ...
        [
            __SYD.gallery_feature_images_comp_child1(0),
            __c(
                'div',
                {
                ...
                [
                    __SYD.gallery_feature_images_comp_child2(1),
                    __c(
                        'div',
                        {
                        ...
                        [
                            __SYD.gallery_feature_images_comp_child3(2),
...
__SYD.gallery_feature_images_comp_child1 = (i) =>{
    return __c(
        'div',
        {
            style:`height:70vw;width:${__p(['hsec5_img_gallery_static','flex_param'],'row') === 'row' ? '30%' : '70%'};min-width:250px;max-height:380px;background-position:center 0;background-image:url("../assets/${images[__p(['hsec5_img_gallery_static','currentIndex'],0)][i]}");`+__sC['border-rad-15'](),
            class:'thin_border'
        },[],{genericStyle:['bg_cover']}
    )
}

__SYD.gallery_feature_images_comp_child2 = (i) =>{
    return __c(
        'div',
        {
            style:`min-height:${__p(['hsec5_img_gallery_static','flex_param'],'row') === 'row' ? '50%' : '33vw'};width:100%;background-position:center 0;background-image:url("../assets/${images[__p(['hsec5_img_gallery_static','currentIndex'],0)][i]}");`+__sC['border-rad-15'](),
            class:'thin_border'
        },[],{genericStyle:['bg_cover']}
    )
}

__SYD.gallery_feature_images_comp_child3 = (i) =>{
    return __c(
        'div',
        {
            style:`height:100%;width:${__p(['hsec5_img_gallery_static','flex_param'],'row') === 'row' ? '50%' : '100%'};background-position:center 0;background-image:url("../assets/${images[__p(['hsec5_img_gallery_static','currentIndex'],0)][i]}");`+__sC['border-rad-15'](),
            class:'thin_border'
        },[],{genericStyle:['bg_cover']}
    )
}
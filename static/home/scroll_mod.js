...
const scroll_element = ['hsec2_increment_counter_parent' , 'hsec3_video_container' , 'hsec8_static_overlay_image' , 'hsec9_static_overlay_image' ,'hsec4_img_gallery_main_1' ,'hsec6_text_img_array','hsec5_img_gallery_static','hsec7_tetimonial_temp_comp'];
...
addEventListener('scroll', e =>{//__v[scroll_element[0]].offsetTop - 120
    ...
    {
        if(window.scrollY > __v[scroll_element[i]].offsetTop - (window.innerHeight/2))
        {

...
__SYD.h_page_1_cont_text_cont_1 = () =>{
    return __c(
        ...
        [
            __SYD.text_lib_type_h1_glob({cnt:'Welcome to Lahor Luxury Apartments',size:__p(['h_page_1_cont','font'],'45px') === '45px' ? '20px' : '18px' , w:'900' , inject:'font-family:my_family;text-transform:capitalize;line-height:60px' , clr:'#b99d75' , cls:'downSlide_animate'}),
            __SYD.text_lib_type_h1_glob({cnt:'A sleek, comfortable short-let with modern features and a prime location',size:__p(['h_page_1_cont','font'],'45px') , w:'500' , inject:'text-transform:capitalize;line-height:60px;max-width:900px;width:100%;animation-delay:.7s;' , clr:'inherit' ,cls:'rotateZ_incoming_css_animation'}),
        ]
    )
}

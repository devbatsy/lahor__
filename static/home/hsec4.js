...
__SYD.hsec4_img_gallery_main_1 = () =>{
    return __c(
        ...
        [
            ...
            __SYD.text_lib_type_p_glob_vfit({cnt:'Check out some of our shortlet apartments in the city of Abuja',size:'14px',clr:'#fff',inject:'line-height:25px;width:100%;text-align:left;padding-left:10px;'}),

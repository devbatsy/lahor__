    ...
    return __c(
        ...
        [
            ...
            __c(
                'div',
                {
                    style:`padding:10px;background:#0be10a;position:absolute;top:110px;right:15px;z-index:200;border-radius:15px;border-top-right-radius:0;font-size:12px;box-shadow:-1px 2px 3px #000;z-index:300;cursor:pointer;display:${__p(['container' , 'renderMode'],'gallery') === 'gallery' ? 'block' : 'none'}`,
